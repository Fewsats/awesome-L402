...
- [Satoshi BTC API](https://satoshiapi.io) - Real-time Bitcoin intelligence API. Pay 10-25 sats per request via Lightning. Endpoints: BTC price, mempool fees, block height, Fear & Greed index. Native L402 (no Aperture), runs on LND over Tor. [Source](https://github.com/BodyOdor/satoshi-btc-api).
